...
# Precise pixel coordinates of the pouch face on each created scene (x1, y1, x2, y2)
# Scene resolution: 896x1200 or 1000x1333
configs = [
    {
        ...
        'real_crop_pct': (0.165, 0.225, 0.90, 0.72),
    ...
    },
    {
        ...
        'real_crop_pct': (0.105, 0.20, 0.91, 0.745),
    ...
    },
    {
        ...
        'real_crop_pct': (0.085, 0.22, 0.84, 0.75),
    ...
    },
    {
        ...
        'real_crop_pct': (0.075, 0.15, 0.87, 0.77),
    ...
    },
    {
        ...
        'real_crop_pct': (0.055, 0.18, 0.88, 0.76),
    ...
    },
    {
        ...
        'real_crop_pct': (0.145, 0.19, 0.91, 0.745),
    ...
    },
    {
        ...
        'real_crop_pct': (0.125, 0.265, 0.83, 0.735),
        'pouch_box_pct': (0.21, 0.245, 0.81, 0.755)
    }
]
...
def embed_design(item):
    ...
    print(f'Flawlessly aligned: {item["out"]}')

for item in configs:
    embed_design(item)

print('All 7 products flawlessly aligned and embedded!')
